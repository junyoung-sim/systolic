...
typedef struct hybridSimInfoT {
    ...
    struct hybridSimReferrerData * I959;
} hybridSimInfoT;
...
typedef struct {
    U  I657;
    U  I665;
    RmaThreadSchedCompiledLoads  * I1136;
...
typedef struct {
    ...
    U  I1138;
    RmaIbfIp  * I1139;
    RmaThreadSchedCompiledLoadsArr  I1140;
} RmaJaguarIbnSchedCg;
typedef struct {
    RP  I1141;
} RmaRootCbkCg;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    RmaSeqPrimOutputOnClkOpt  I1238;
    RmaSeqPrimOutputEblkData  I1243;
...
struct dummyq_struct {
    ...
    struct futq * I1359;
    struct futq * I1360;
    struct sched_table * I1361;
    struct futq_info * I1363;
    ...
    EBLK  * I1422;
    int I1423;
    struct vcs_globals_t * I1424;
    clock_struct  I1426;
    unsigned long long I1427;
    EBLK  * I1428;
    EBLK  * I1429;
    void * I1430;
...
void  rmaPropagate0_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate1_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate2_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate3_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate4_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate5_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
...
void  rmaPropagate6_f_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
